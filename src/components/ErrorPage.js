  ...
  if (error === '404') {
    return (
      ...
      <div className="main-error-page">
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="470" height="290" viewBox="0 0 470 290">
          ...
          <g fill="none" fillRule="evenodd">
            ...
            <g transform="translate(-448 -157) translate(448 157)">
              ...
              <g fillRule="nonzero" stroke="#979797" strokeLinecap="round" strokeWidth="1.8" className="left-sparks">
              ...
              <g fillRule="nonzero" stroke="#979797" strokeLinecap="round" strokeWidth="1.8" className="right-sparks">
        ...
        <Link to="/" className="link_404" >Return</Link>
    ...
    return (
      ...
      <div className="error">
        ...
        <p className="error-message">
          Oops. The address you are looking for is not available. Have you tried searching another one?</p>
      </div>
    );
  }
};
